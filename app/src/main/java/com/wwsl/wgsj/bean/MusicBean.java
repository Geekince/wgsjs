...
public class MusicBean implements Parcelable {
    ...
    public static MusicBean parse(VideoMusicBean videoMusicBean) {
        if (videoMusicBean == null) return null;
        MusicBean bean = new MusicBean();
        bean.setId(Integer.parseInt(videoMusicBean.getId()));
        bean.setAuthor(videoMusicBean.getAuthor());
        bean.setImgUrl(videoMusicBean.getImgUrl());
        bean.setLength(videoMusicBean.getLength());
        bean.setFileUrl(videoMusicBean.getFileUrl());
        bean.setUseNum(videoMusicBean.getUseNum());
        bean.setLocalPath("");
        return bean;
    }
}
