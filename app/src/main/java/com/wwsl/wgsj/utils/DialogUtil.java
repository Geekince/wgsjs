...
import com.wwsl.wgsj.bean.LocalOccupationBean;
import com.wwsl.wgsj.bean.PartnerCityBean;
import com.wwsl.wgsj.dialog.AtFriendDialog;
import com.wwsl.wgsj.dialog.AuthPayDialog;
import com.wwsl.wgsj.dialog.HometownSetDialog;
import com.wwsl.wgsj.dialog.ProgressDialog;
import com.wwsl.wgsj.dialog.ProtocolDialog;
import com.wwsl.wgsj.dialog.RedPacketDialog;
...
import com.wwsl.wgsj.views.dialog.OneChooseWheel;
import com.wwsl.wgsj.views.dialog.TwoChooseWheel;
...
public class DialogUtil {
    ...
    public static void showSimpleDialog(Context context, String content, boolean cancelable,
    ...
    public static void showSimpleDialog(Context context, String title, String content,
                                        boolean cancelable, SimpleCallback callback) {
        new Builder(context)
                .setTitle(title)
                .setContent(content)
    ...
    public static void showSimpleInputDialog(Context context, String title, String content,
                                             String hint, int inputType, int length, int cancelTextColor, SimpleCallback callback) {
    ...
    public static void showSimpleInputDialog(Context context, String title, String hint,
                                             int inputType, int length, int cancelTextColor, SimpleCallback callback) {
        new Builder(context).setTitle(title)
                .setCancelable(true)
                .setInput(true)
                .setHint(hint)
    ...
    public static void showSimpleInputDialog(Context context, String title, int inputType, int length,
                                             int cancelTextColor, SimpleCallback callback) {
    ...
    public static void showSimpleInputDialog(Context context, String title, int inputType,
                                             SimpleCallback callback) {
    ...
    public static void showSimpleInputDialogWithoutCancel(Context context, String title, String hint,
                                                          int inputType, int length, SimpleCallback callback) {
        new Builder(context).setTitle(title)
                .setCancelable(false)
                .setInput(true)
    ...
    public static void showSysTipsDialog(Context context, final SimpleCallback callback) {
        ...
        params.gravity = Gravity.CENTER;
        window.setAttributes(params);
        ((TextView) dialog.findViewById(R.id.txContent)).setText(
                AppConfig.getInstance().getConfig().getSysTips());
    ...
    public static void showContentTipsDialog(Context context, String title, String content,
    ...
    public static void showStringArrayDialog(Context context, Integer[] array,
                                             final StringArrayDialogCallback callback) {
        final Dialog dialog = new Dialog(context, R.style.dialog2);
        ...
        for (int i = 0, length = array.length; i < length; i++) {
            ...
            textView.setLayoutParams(
                    new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DpUtil.dp2px(54)));
    ...
    public static void showStringArrayDialog(Context context, SparseArray<String> array,
                                             final StringArrayDialogCallback callback) {
        final Dialog dialog = new Dialog(context, R.style.dialog);
        dialog.setContentView(R.layout.dialog_string_array);
        dialog.setCancelable(true);
        ...
        for (int i = 0, length = array.size(); i < length; i++) {
            ...
            if (i != length - 1) {
                View v = new View(context);
                v.setLayoutParams(
                        new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DpUtil.dp2px(1)));
    ...
    public static class Builder {
        ...
        public Dialog build() {
            final Dialog dialog =
                    new Dialog(mContext, mBackgroundDimEnabled ? R.style.dialog : R.style.dialog2);
    ...
    public static ChooseAddressWheel getCityDetailDialog(Activity context,
                                                         List<PartnerCityBean> cityBeans, OnAddressChangeListener listener) {
        ChooseAddressWheel chooseAddressWheel = new ChooseAddressWheel(context);
        chooseAddressWheel.setOnAddressChangeListener(listener);
    ...
    public static TwoChooseWheel getProvinceDialog(Activity activity,
                                                   TwoChooseWheel.OnDataChoseListener listener) {
    ...
    public static TwoChooseWheel getProvinceCityDialog(Activity activity, String title,
                                                       Map<String, List<String>> map, TwoChooseWheel.OnDataChoseListener listener) {
    ...
    public static OneChooseWheel getSingleCityDialog(Activity activity, String title,
                                                     List<String> data, OneChooseWheel.OnDataChoseListener listener) {
     ...
     * 图片,文字 确认按钮 dialog
     */
    public static SimpleCenterDialog getSimpleCenterDialog(Context context, int imgRes, int imgWith,
                                                           int imgHeight, String content) {
     ...
     * 图片,文字 确认按钮 dialog
     */
    public static SimpleCenterDialog getSimpleCenterDialog(Context context, String imgRes,
                                                           int imgWith, int imgHeight, String content) {
        return (SimpleCenterDialog) new XPopup.Builder(context)
                .hasShadowBg(false)
                .dismissOnTouchOutside(true)
                .customAnimator(new DialogAnimator())
    ...
    public static SimpleCenterDialog getSimpleCenterDialog(Context context, String imgRes,
        ...
        return (SimpleCenterDialog) new XPopup.Builder(context)
                ...
                .customAnimator(new DialogAnimator())
                .asCustom(
                        new SimpleCenterDialog(context, imgRes, imgWith, imgHeight, marginTop, marginBottom,
                                marginStart, marginEnd, content, null));
    }

    /**
     * 认证支付弹窗
     */
    public static void showAuthPayDialog(Context context, String pirce,
     ...
     * 图片,文字 确认按钮 dialog
     */
    public static void showRedPacketDialog(@NonNull Context context, boolean isSelfSend,
                                           String packetId, String price, String status, OnDialogCallBackListener listener) {
        new XPopup.Builder(context)
                .hasShadowBg(false)
                .dismissOnTouchOutside(true)
                .customAnimator(new DialogAnimator())
     ...
     * 图片,文字 确认按钮 dialog
     */
    public static AtFriendDialog getAtFriendDialog(Context context, String uid,
                                                   OnDialogCallBackListener listener) {
     ...
     * 图片,文字 确认按钮 dialog
     */
    public static HometownSetDialog getHometownSetDialog(Activity activity,
                                                         OnDialogCallBackListener listener) {
    ...
    public static void showProtocolDialog(final Context context, OnDialogCallBackListener listener) {
        new XPopup.Builder(context)
                .hasShadowBg(false)
                .dismissOnTouchOutside(false)
                .customAnimator(new DialogAnimator())
                .asCustom(new ProtocolDialog(context, listener))
                .show();
    }
}
