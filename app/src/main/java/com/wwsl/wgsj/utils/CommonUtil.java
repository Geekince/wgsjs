...
//        mPictureParameterStyle.pictureOriginalTextSize = 14;
    ...
    public static View getEmptyView2(String text, Context context, ViewGroup parent) {
        View emptyView = LayoutInflater.from(context).inflate(R.layout.view_no_data_text2, parent, false);
        TextView textView = emptyView.findViewById(R.id.text);
        if (StrUtil.isEmpty(text)) text = "暂无数据";
        textView.setText(text);
        return emptyView;
