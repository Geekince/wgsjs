...
public class Constants {
  ...
  public static final String USER_IS_AGREE_PROTOCOL = "agree_protocol";
  public static final String MQ_PREFIX              = "mq_";
  public static final String PAYLOAD                = "payload";
  public static final String APP_APK                = "APP_APK";
  public static final String APK_FILE_NAME          = "wgsj.apk";
  ...
  public static final String MD_BEAN                = "MD_BEAN";
  public static final String USER_VIDEO_BEAN        = "userVideoBean";
  ...
  public static final String VIDEO_DS_ID            = "VIDEO_DS_ID";
  public static final String VIDEO_DS_UID           = "VIDEO_DS_UID";
  ...
  public static final int    PAY_TYPE_BANK          = 8003;

  public static final String PAY_STR_TYPE_ALI  = "alipay";
  public static final String PAY_STR_TYPE_WX   = "wxpay";
  public static final String PAY_STR_TYPE_BANK = "yinlian";
  ...
  public static final String GIF_GAME_PREFIX        = "gif_game_";
  ...
  public static final int    SETTING_SET_PAY_PWD    = 19;
  public static final int    SETTING_SET_ACCOUNT    = 21;
  public static final int    SETTING_SET_USER_INFO  = 22;
  public static final int    SETTING_               = 19;
  ...
  public static final int    FOLLOW_FROM_VIDEO_LIKE = 1009;
  public static final int    FOLLOW_FROM_MAIN_MSG   = 1010;
  //直播房间类型
  ...
  //发送文字消息，点亮，用户进房间  PS:这种混乱的设计是因为服务器端逻辑就是这样设计的,客户端无法自行修改
  ...
  public static final String VIDEO_HOME_TAB          = "videoHome_";
  ...
  public static final int    AUTH_STATUS_DEFAULT = 3;
  public static final int    AUTH_STATUS_NO      = 2;
  ...
  public static final String KEY_VIDEO_COMMENT_NUM = "video_comment_num";

  public static final int MESSAGE_TYPE_MSG            = 1;
  public static final int MESSAGE_TYPE_TEXT_LABEL     = 2;
  public static final int MESSAGE_TYPE_TEXT_RECOMMEND = 3;
  public static final int MESSAGE_TYPE_AD             = 4;

  public static final int MESSAGE_SUBTYPE_FRIEND         = 0;
  public static final int MESSAGE_SUBTYPE_SYS_NOTICE     = 1;//系统消息
  public static final int MESSAGE_SUBTYPE_ASSISTANT_MD   = 2;//其他消息
  public static final int MESSAGE_SUBTYPE_ASSISTANT_SHOP = 3;//令牌助手
  public static final int MESSAGE_SUBTYPE_ASSISTANT_LIVE = 4;//直播助手

  //<editor-fold desc="MessageSecondType 消息二级页面">
  ...
  public static final int EXCHANGE_TYPE_DOUDING      = 0;//元宝兑换
  public static final int EXCHANGE_TYPE_BALANCE      = 1;//余额提现
  public static final int EXCHANGE_TYPE_DD_DEPOSIT   = 2;//福利元宝提现
  public static final int EXCHANGE_TYPE_DD_2_BALANCE = 3;//福利元宝转换余额

  //<editor-fold desc="Share platform">
  public static final int MSG_FRIEND    = 1000;
  public static final int SAVE_LOCAL    = 1001;
  public static final int DELETE_VIDEO  = 1002;
  public static final int VIDEO_REPORT  = 1003;
  public static final int WEIXIN_CIRCLE = 0;
  public static final int WEIXIN        = 1;
  public static final int QQ            = 2;
  //</editor-fold>

  public static String AGE_DEFAULT = "保密";
  ...
  public static final int ORDER_DEFAULT_SUCCESS = 8;

  public static final int VIDEO_CLICK_HEAD    = 0;
  public static final int VIDEO_CLICK_LIKE    = 1;
  public static final int VIDEO_CLICK_COMMENT = 2;
  public static final int VIDEO_CLICK_SHARE   = 3;
  public static final int VIDEO_CLICK_FOLLOW  = 4;
  public static final int VIDEO_CLICK_TITLE   = 5;
  public static final int VIDEO_CLICK_MUSIC   = 6;
  public static final int VIDEO_CLICK_AD      = 7;
  public static final int VIDEO_CLICK_GOODS   = 8;
