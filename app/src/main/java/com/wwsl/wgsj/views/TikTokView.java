...
import com.wwsl.wgsj.custom.VideoLoadingBar;
...
import com.wwsl.wgsj.utils.tiktok.AutoLinkHerfManager;
...
//                LogUtils.e(TAG, "setProgress: duration:" + duration + "-----position:" + position + "------rate:" + pos);
    ...
    public void setVideoData(VideoBean videoData) {
        ...
        ImgLoader.display(videoData.getUserBean().getAvatar(), ivHead);
...
//        ImgLoader.display(R.mipmap.img_default_bg, thumb);
        ImgLoader.display(videoData.getCoverUrl(), 0, R.drawable.bg_title, thumb);
        //点赞状态
...
//            animationView.setVisibility(VISIBLE);
    ...
    public void setRLayoutPadding() {
        int dip2px = MQUtils.dip2px(super.getContext(), 50);
        rLayout.setPadding(0, 0, 0, dip2px);
    }
}
