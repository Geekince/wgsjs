...
public class MadelWallActivity extends BaseActivity implements OnDialogCallBackListener {
   ...
   /* private int[] greyRes = new int[]{R.mipmap.icon_madel_grey_1, R.mipmap.icon_madel_grey_2, R.mipmap.icon_madel_grey_3,
    ...
    private int[] greyRes = new int[]{R.mipmap.icon_madel0_off, R.mipmap.icon_madel_1_off, R.mipmap.icon_madel_2_off, R.mipmap.icon_madel_3_off};
    private int[] lightRes = new int[]{R.mipmap.icon_madel0_on, R.mipmap.icon_madel_1_on, R.mipmap.icon_madel_2_on, R.mipmap.icon_madel_3_on};
    ...
    protected void init() {
        ...
        data.add(MadelBean.builder().id(1).name("准星达人").enableUrl(lightRes[0]).disableUrl(greyRes[0]).enable(false).build());
        data.add(MadelBean.builder().id(2).name("一星达人").enableUrl(lightRes[1]).disableUrl(greyRes[1]).enable(false).build());
        data.add(MadelBean.builder().id(3).name("二星达人").enableUrl(lightRes[2]).disableUrl(greyRes[2]).enable(false).build());
        data.add(MadelBean.builder().id(4).name("三星达人").enableUrl(lightRes[3]).disableUrl(greyRes[3]).enable(false).build());
