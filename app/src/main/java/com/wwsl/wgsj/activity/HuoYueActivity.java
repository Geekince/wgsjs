...
import com.wwsl.wgsj.adapter.ActiveAdapter;
...
import com.wwsl.wgsj.bean.net.NetActiveRecordBean;
            ...
            public void onSuccess(int code, String msg, String[] info) {
                ...
                if (code == 200 && null != info && info.length > 0) {
                    ...
                    if (null != parse) {
                        ...
                        num1.setText(StringUtil.checkNullStr(parse.getRemainIncome(), "0.0"));
...
//                        num6.setText(parse.getBaseActive());
    ...
    private void changeMode() {
        tvLabel4.setText(selectedIndex == 1 ? "我的活跃记录" : "收支明细");
