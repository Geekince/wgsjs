...
import com.wwsl.wgsj.bean.maodou.StallItemBean;
...
public class MdStallActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        mdBeans.add(StallItemBean.builder().id("0").name("傻1哈").title("令牌/191.00个元宝").build());
        mdBeans.add(StallItemBean.builder().id("1").name("傻2哈").title("令牌/192.00个元宝").build());
        mdBeans.add(StallItemBean.builder().id("2").name("傻3哈").title("令牌/193.00个元宝").build());
        mdBeans.add(StallItemBean.builder().id("3").name("傻4哈").title("令牌/194.00个元宝").build());
        mdBeans.add(StallItemBean.builder().id("4").name("傻5哈").title("令牌/195.00个元宝").build());

        ddBeans.add(StallItemBean.builder().id("0").name("傻1哈").title("191.00个元宝/令牌").build());
        ddBeans.add(StallItemBean.builder().id("1").name("傻2哈").title("192.00个元宝/令牌").build());
        ddBeans.add(StallItemBean.builder().id("2").name("傻3哈").title("193.00个元宝/令牌").build());
        ddBeans.add(StallItemBean.builder().id("3").name("傻4哈").title("194.00个元宝/令牌").build());
        ddBeans.add(StallItemBean.builder().id("4").name("傻5哈").title("195.00个元宝/令牌").build());
