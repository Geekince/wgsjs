...
import com.wwsl.wgsj.fragment.WorkFragment;
...
//                startActivity(new Intent(getActivity(), FollowActivity.class));
    ...
    private void openReport() {
        DialogUtil.showStringArrayDialog(this, new Integer[]{
                R.string.live_user_jubao}, new DialogUtil.StringArrayDialogCallback() {
            @Override
            public void onItemClick(String text, int tag) {
                if (tag == R.string.live_user_jubao) {
                    VideoReportActivity.forward(UserHomePageActivity.this, userId);
                }
            }
        });
    }
    ...
    private void clearUI() {
        ...
        ImgLoader.display(R.drawable.bg_title, ivHead);
