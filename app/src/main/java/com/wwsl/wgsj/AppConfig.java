...
import com.wwsl.wgsj.bean.VideoTagBean;
import com.wwsl.wgsj.bean.VideoTypeBean;
...
public class AppConfig {
    ...
    public static final String channelId = "wgsj";
    ...
    //文件夹名字
    private static final String DIR_NAME = "wgsj";
