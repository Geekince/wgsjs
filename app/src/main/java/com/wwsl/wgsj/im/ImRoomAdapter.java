...
import com.wwsl.wgsj.custom.BubbleLayout;
import com.wwsl.wgsj.custom.ChatVoiceLayout;
...
public class ImRoomAdapter extends RecyclerView.Adapter {
    ...
    class VideoVh extends Vh {
        ...
        public VideoVh(View itemView) {
            ...
            videoAvatar = itemView.findViewById(R.id.videoAvatar);
        ...
        public void setData(ImMessageBean bean, int position, Object payload) {
            ...
            if (payload == null) {
                ...
                ImgLoader.display(cover, R.mipmap.img_default_bg, mImg);
