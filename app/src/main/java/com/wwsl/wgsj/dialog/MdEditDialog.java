...
public class MdEditDialog extends BasePopupView implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void initView() {
        if (type == TYPE_SALE) {
            ...
            HttpUtil.getTodayPrice(new HttpCallback() {
                ...
                public void onSuccess(int code, String msg, String[] info) {
                    if (code == 200) {
                        ...
                        saleLabel.setText(String.format("当前令牌市场价格：%sR/个", todayPrice));
                    }
                }
            });

        } else {
            tvTitle.setText("我要令牌");
            ...
            tvBuyNum.setText(String.format("令牌数量：%s个", data.getNumber()));
    ...
    protected void onDismiss() {
        ...
        tvUploadQr.setImageResource(R.mipmap.bg_upload_qr);
    }
}
