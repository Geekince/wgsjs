...
public class MainListAdapter extends RefreshAdapter<ListBean> {
    ...
    public void setGiftContribute(boolean isGiftContribute) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == HEAD) {
            ...
            return new Vh(mInflater.inflate(R.layout.item_rank_list, parent, false));
        }
    }
...
//            mBtnFollow3.setOnClickListener(mFollowClickListener1);
        ...
        void setData(Object payload) {
            if (isGiftContribute) {
                mName1.setTextColor(mContext.getResources().getColor(R.color.orange_lite));
                mName2.setTextColor(mContext.getResources().getColor(R.color.orange_lite));
                mName3.setTextColor(mContext.getResources().getColor(R.color.orange_lite));
                mVotes1.setTextColor(mContext.getResources().getColor(R.color.orange));
                mVotes2.setTextColor(mContext.getResources().getColor(R.color.orange));
                mVotes3.setTextColor(mContext.getResources().getColor(R.color.orange));
            }
...
//                }
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        RelativeLayout layoutListItemBg;
        TextView mOrder;
        ImageView mAvatar;
        TextView mName;
        TextView mVotes;
...
//        ImageView mLevel;
        ...
        public Vh(View itemView) {
            super(itemView);
            viewItemDivider = itemView.findViewById(R.id.viewItemDivider);
            layoutListItemBg = itemView.findViewById(R.id.layoutListItemBg);
...
//            mBtnFollow.setOnClickListener(mFollowClickListener2);
        ...
        void setData(ListBean bean, int position, Object payload) {
            if (position == 0) {
                ...
                if (isGiftContribute) {
                    layoutListItemBg.setBackgroundResource(R.drawable.bg_white_shadow_top);
                } else {
                    layoutListItemBg.setBackgroundResource(R.drawable.bg_white_top);
                }
            } else if (position == mList.size() - 1) {
                if (isGiftContribute) {
                    layoutListItemBg.setBackgroundResource(R.drawable.bg_white_shadow_bottom);
                } else {
                ...
                if (isGiftContribute) {
                    layoutListItemBg.setBackgroundResource(R.drawable.bg_white_shadow_center);
                } else {
